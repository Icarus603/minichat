...
export const InputBox = ({ onSend, loading, onInterrupt, onCommand, }) => {
    const { sessionsOpen, modelPickerOpen, modelPickerStage, modelPickerLoading, modelPickerError, modelOptions, modelSelectedIndex, currentModel, currentReasoningEffort, modelQuery, modelEffortOptions, } = useUIState();
    const { onModelMove, onModelSelect, onModelClose, onModelQueryChange, } = useUIActions();
